...
MIN_SOL_RESERVE = 0.015 # Iets hogere reserve voor veiligheid
...
# Model Settings
GEMINI_MODEL = "gemini-3.1-pro-preview"  # Gebruik de allernieuwste Gemini 3.1 Pro voor maximale intelligentie
