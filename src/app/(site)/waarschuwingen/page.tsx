...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: "Actuele waarschuwingen voor jouw provincie, zonder ruis.",
  },
};
...
export default async function ReedPage() {
  ...
  const [initialWeather, allWarnings, provinceSlug, estofex] = await Promise.all([fetchWeatherData(lat, lon, false, true).catch(() => undefined),
            ...
            {estofex && estofexSummary && (
              <div className="rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 p-5">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded-md ${estofex.maxLevel >= 3 ? "bg-rose-500/30 text-rose-100" :
