...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      "WEERZONE vs Buienradar — nauwkeurigheid, hyperlokale data, prijzen and waarschuwingen vergeleken.",
  },
};
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="card p-6">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  ...
                  <li className="flex gap-2"><span className="text-sky-600 shrink-0">✅</span> API and zakelijke opties (Steve-abonnement)</li>
                </ul>
